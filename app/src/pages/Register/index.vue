<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>确认密码:</label>
        <input type="password" placeholder="请输入确认密码" v-model="passwordre">
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="controls">
  ...
  export default {
    ...
    methods:{
     ...
     async userRegister(){
      try {
        //如果注册成功跳转登录
        let {phone,code,password,passwordre} = this;
        (phone&&code&&password==passwordre)&& await this.$store.dispatch('userRegister',{phone,code,password,passwordre})
        alert('成功注册')
