  ...
  <div class="cart">
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isAllChecked&&cartInfoList.length >1" 
  ...
  export default {
    ...
    methods:{
      ...
      async deleteCartById(cart){
        try {
         await this.$store.dispatch('deleteCartByIdSkuId',cart.skuId)
          this.getData()
        }catch(error) {
          alert(error.message)
        }
    ...
    computed:{
      ...
      totalPrice(){
        ...
        .reduce((total, item) => (total += item.skuNum*item.skuPrice ), 0)
